...
const GetAllStudent = () => {
    ...
    if (window.confirm("Are you sure you want to edit this student?")) {
      try {
        const response = await axios.post(
          "http://localhost:8800/api/editstudent",
          {
  ...
  const handleDelete = async (prn) => {
    ...
    if (window.confirm("Are you sure you want to delete this student?")) {
      try {
        const response = await axios.post(
          "http://localhost:8800/api/deleteStudent",
          {
            prn,
          }
        );
  ...
  let sortedData = filteredData?.length ? [...filteredData] : [];
                ...
                <tr>
                  <th>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleSearchChange("prn", e.target.value)
                      }
                    />
                  </th>
                  <th>
