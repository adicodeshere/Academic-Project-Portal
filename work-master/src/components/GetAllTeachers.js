  ...
  const fetchData = useCallback(async () => {
    try {
      ...
      const response2 = await axios.get(
        "http://localhost:8800/api/getteacherproject"
      );
      console.log(response.data);
      console.log(response2.data);
      let data = [];
      for (let i = 0; i < response.data.length; i++) {
        data[i] = { ...response.data[i], ...response2.data[i] };
      }
      console.log(data);
    ...
    if (window.confirm("Are you sure you want to delete this teacher?")) {
      try {
        const response = await axios.post(
          "http://localhost:8800/api/deleteTeacher",
          {
            teacher_id,
          }
        );
            ...
            <Table striped bordered hover>
              <thead>
                <tr>
                  ...
                  <th onClick={() => handleSort("ProjectCount")}>
                    Number of Project Allocated{" "}
                ...
                <tr>
                  <th>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleSearchChange("teacherId", e.target.value)
                      }
                    />
                  </th>
                  <th>
                  ...
                  <th>
                    <Form.Control
                      ...
                      onChange={(e) =>
                        handleSearchChange("contact", e.target.value)
                      }
                    />
                  </th>
                  <th>
                  ...
                  <th>
                    <Form.Control
                      type="text"
                      placeholder="Search ProjectCount"
                      onChange={(e) =>
                        handleSearchChange("ProjectCount", e.target.value)
                      }
                    />
                  </th>
                </tr>
